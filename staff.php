...
<div class="sidebar">
  ...
  <div class="content">
    <div class="main">
      <div class="header">Administration Staff Dashboard</div>
    ...
    <br><br>
      ...
      if (isset($_POST['submit'])) {
          ...
          $sql = 'SELECT * FROM admintbl WHERE F_name = "'.$search.'"';
    ...
    while($row = mysqli_fetch_array($result)) {
        ...
        echo "<td>" . $row['DOB'] . "</td>";
        echo "<td>" . $row['email'] . "</td>";
        echo "<td><a href='delete.php?delAdmin=" . $row['adminID'] . "' onClick=\"return confirm('Do you really need to delete?');\">Delete</a></td>";
        echo "</tr>";
    }
    echo "</table>";
    ?>
